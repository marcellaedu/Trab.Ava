...
?>
    <center>
        <div style="width: 50rem; margin-top: 35px; border-radius: 20px;">
            <div class="card-body">
                <h5 class="card-title" style="color: #141E46; text-shadow: 0.2em 0.1em 0.3em black; text-align: center;"><b>Um pouco sobre nós..</b></h5>
                ...
                Hoje, o site é um farol para amantes de histórias de todas as idades, reunindo pessoas de todos os cantos em sua busca por narrativas emocionantes. As amigas, enquanto continuam sua jornada explorando novos mundos literários e cinematográficos, têm a satisfação de saber que sua paixão por histórias trouxe alegria e inspiração a muitos.
                </pre>    
                </p>
                <a href="<?= BASE_URL ?>/view/avaliacao/listar.php" style="color: #FF6969; text-decoration: underline;" class="card-link" >Avaliações</a>
            </div>
        </div>
    </center>
