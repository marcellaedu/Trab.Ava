...
<h4 class="mt-3" style="text-align: center;">Listagem de alunos</h4>
    ...
    <tbody>
        <?php foreach($avaliacao as $a): ?>
            <tr>
                ...
                <svg style="justify-content:center;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                ...
                <td><a href="excluir.php?idAvaliacao=<?= $a->getId() ?>"
                       onclick="return confirm('Confirma a exclusão?');" > 
                        <svg style="justify-content:center;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
